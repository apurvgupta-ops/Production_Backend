...
export const validateQuery = (schema) => {
    return (req, res, next) => {
        ...
        if (error) {
            ...
            return sendValidationErrorResponse(res, 'Query validation failed', errorMessages);
        }
...
export const validateParams = (schema) => {
    return (req, res, next) => {
        ...
        if (error) {
            ...
            return sendValidationErrorResponse(res, 'Parameter validation failed', errorMessages);
        }
